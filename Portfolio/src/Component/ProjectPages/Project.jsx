...
function Project() {
  const projects = [
    ...
    },
    {
      id: 3,
      title: "E-Shop Store",
      description: "An e-commerce platform with product browsing, shopping cart, and secure checkout. Complete shopping experience with modern design and fast performance.",
